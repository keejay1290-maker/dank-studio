...
const NEW_CATEGORIES = `
    ...
    ['clothing_gear',   ['clothes', 'clothing', 'vest', 'backpack', 'helmet', 'mask', 'gear', 'shirt', 'pants', 'boots', 'shoes', 'gloves', 'jacket', 'coat', 'hat', 'cap', 'balaclava', 'ghillie', 'belt', 'holster', 'uniform']],
    ['weapons',         ['weapon', 'gun', 'rifle', 'pistol', 'akm', 'm4a1', 'svd', 'vss', 'mosin', 'mag_', 'clip_', 'ammo', 'firearm', 'shotgun', 'sniper_rifle', 'submachine', 'dmr', 'm14', 'aug', 'famas', 'crossbow']],
    ['food_drinks',     ['food', 'drink', 'cola', 'soda', 'can_', 'fruit', 'vegetable', 'meat', 'apple', 'pear', 'pumpkin', 'snack', 'water_bottle', 'canteen', 'cooking', 'kitchen_pot', 'rice', 'cereal', 'honey', 'boar', 'deer', 'steak', 'choco']],
    ['overhauls',       ['overhaul', 'overhual', 'snowverhaul', 'rework', 'revamp', 'rebuild', 'remod', 'remake', 'nature_overhaul', 'overgrown']],
    ['traders',         ['trader', 'shop', 'store', 'superstore', 'megastore', 'gunstore', 'clothshop', 'armory', 'armoury', 'showroom', 'tireshop', 'dealership', 'vending', 'dealer', 'growshop', 'mall', 'blackmarket', 'black_market', 'market', 'tradepost']],
    ...
    ['pvp_events',      ['pvp', 'paintball', 'koth', 'deathmatch', 'squidgame', 'captureflag', 'capture', 'arena', 'maze', 'gulag', 'laser_tag', 'lasertag', 'cqb', 'tribunal']],
    ...
    ['faction_bases',   ['faction', 'clan', 'hq_', 'militia', 'battalion']],
    ...
    ['houses_cabins',   ['house', 'cabin', 'hut', 'shack', 'home', 'retreat', 'shelter', 'apartment', 'hotel', 'cottage', 'ranch', 'camp', 'tent', 'biwop', 'motel', 'cribs', 'mansion', 'villa']],
    ['water_sources',   ['well', 'pump', 'water_well', 'h2o', 'fountain', 'wellpump', 'extrapump']],
    ['industry_factory',['industrial', 'factory', 'quarry', 'sawmill', 'workshop', 'warehouse', 'construction', 'crane', 'industrial_batiment', 'bricks', 'cement', 'quarry', 'junkyard', 'hangar']],
    ...
    ['bases',           ['base', 'shed', 'garage', 'fortress', 'flagstaff', 'garden', 'greenhouse', 'waterbase', 'solobase', 'hideout', 'outpost', 'compound', 'settlement', 'camp', 'compound']],
    ['castles',         ['castle', 'wendigo', 'ruins', 'medieval', 'fortress', 'keep', 'tower_castle', 'castelo']],
    ['safezones',       ['safezone', 'safe_zone', 'sz_']],
    ['vehicles',        ['vehicle', 'truck', 'heli', 'uboat', 'submarine', 'tank', 'trailer', 'aircraft', 'car', 'v3s', 'bus', 'lada', 'gunter', 'sarka', 'olga', 'humvee', 'v3s', 'helicopter', 'plane', 'jet']],
    ['building_supplies',['pallet', 'supply', 'buildpallet', 'buildsup', 'buildtable', 'builderkit', 'builder', 'crate', 'container', 'locker', 'template', 'rack', 'wooden', 'logs', 'planks', 'metal_sheets', 'supplies', 'cont-tiers']],
    ['walls_structures',['wall', 'fence', 'gate', 'ramp', 'stairway', 'spiral', 'barricade', 'fort', 'trench', 'perimetre', 'tower', 'watchtower', 'tawer']],
    ['military',        ['military', 'milbase', 'barracks', 'checkpoint', 'militia', 'zonemili', 'tisy', 'nwaf', 'mb_', 'airfield', 'airbase', 'airstrip', 'radar', 'atc_', 'zenit', 'zennit', 'warhead', 'hq_', 'radio_station', 'chernarusbattalion']],
    ['decorations',     ['flag', 'billboard', 'sign', 'banner', 'speaker', 'statue', 'monument', 'memorial', 'bench', 'light', 'lamp', 'streetlamp', 'spotlight', 'decoration', 'decal', 'cobweb', 'newsstand']],
    ['furniture_interior',['furniture', 'table', 'shelf', 'bed', 'chair', 'desk', 'cabinet', 'interior', 'props', 'decor_', 'kitchen', 'bathroom', 'stove', 'trolley', 'locker', 'casier']],
    ['nature_foliage',  ['tree', 'forest', 'bush', 'landscape', 'rock', 'foliage', 'grass', 'garden', 'plantation', 'hunting', 'animal', 'deerstand']],
    ['loot_configs',    ['loot', 'itemtable', 'economy', 'types', 'events', 'globals', 'spawnabletypes', 'cfgeconomy', 'table', 'config', 'cfg_', 'stash']],
    ['server_config',   ['cfggameplay', 'cfgeffect', 'cfgspawn', 'cfgevent', 'cfgplayer', 'cfgrandom', 'cfglimit', 'cfgignore', 'cfgweather', 'cfgenvironment', 'mapgroup', 'messages', 'spawn', 'weather', 'wipelist', 'init.c', 'validated-json', 'scheduledtasks', 'spawnpoints', 'cffgameplay']],
    ['other_configs',   []],
`;
