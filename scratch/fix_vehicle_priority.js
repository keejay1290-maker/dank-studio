...
const NEW_CATEGORIES = `
    ...
    ['loot_configs',    ['loot', 'itemtable', 'economy', 'types', 'events', 'globals', 'spawnabletypes', 'cfgeconomy', 'table', 'config', 'cfg_', 'stash', 'card', 'keycard', 'punchcard', 'punchedcard']],
    ['building_supplies',['pallet', 'supply', 'buildpallet', 'buildsup', 'buildtable', 'builderkit', 'builder', 'crate', 'container', 'locker', 'template', 'rack', 'wooden', 'logs', 'planks', 'metal_sheets', 'supplies', 'cont-tiers', 'materials', 'material_truck']],
    ...
    ['traders',         ['trader', 'shop', 'store', 'superstore', 'megastore', 'gunstore', 'clothshop', 'armory', 'armoury', 'showroom', 'tireshop', 'dealership', 'vending', 'dealer', 'growshop', 'mall', 'blackmarket', 'black_market', 'market', 'tradepost', 'carstand', 'car_stand']],
    ...
    ['water_sources',   ['well', 'pump', 'water_well', 'h2o', 'fountain', 'wellpump', 'extrapump', 'watertruck']],
    ...
    ['points_of_interest', ['poi', 'location', 'spot', 'markup', 'marker', 'area', 'town', 'village', 'city', 'crossroad', 'intersection', 'bridge', 'lake', 'mountain', 'hill', 'island', 'beach', 'coast', 'forest', 'swamp', 'radio', 'truckstop', 'busstop', 'carstation']],
